...
//  }
  ...
  <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full max-w-md border-4 ">
    <div className="mb-8">
      <label
      ...
      <input
        ...
        id="username" type="text" placeholder="Roll Number"/>
    </div>
    <div className="mb-32">
      <label
        className="block text-gray-700 text-2xl font-bold mb-2"
      ...
      <input
        ...
        placeholder="******************"
      />
      <p className="text-red-500 text-base italic">Please choose a password.</p>
